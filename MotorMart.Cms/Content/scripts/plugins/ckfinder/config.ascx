...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        JellyfishCms.User.AppCookies cookies = new JellyfishCms.User.AppCookies(new JellyfishCms.User.CookieContainer());        
        JellyfishCms.Session.SessionManager.Current.UserAccountId = cookies.UserAccountId ?? 0;

        return  JellyfishCms.Session.SessionManager.Current.IsAuthenticated();
	}
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = JellyfishCms.Common.AdminSettings.CKFinderBaseUrl;

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
		BaseDir = JellyfishCms.Common.AdminSettings.CKFinderBaseDir;
        //BaseDir = "C:/Projects/WebSites/.NET 3.5/Manches/Manches/userfiles/";
